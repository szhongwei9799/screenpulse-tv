...
interface PlaylistConfigDao {
    ...
    @Query("UPDATE playlist_config SET orderMode = :mode, lastUpdated = :timestamp WHERE id = 1")
    suspend fun setOrderMode(mode: String, timestamp: Long = System.currentTimeMillis())
